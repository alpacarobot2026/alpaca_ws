...
class MTRDecoder(nn.Module):
    ...
    def forward(self, query_token, time_emb=None, agent_mask=None):
        """
        ...
        if agent_mask is not None:
            agent_key_padding_mask = repeat(~agent_mask.bool(), 'b a -> (b k) a', k=K)
        ...
        for i in range(self.num_blocks):
            ...
            cur_query = self.self_attn_A[i](cur_query, src_key_padding_mask=agent_key_padding_mask)
